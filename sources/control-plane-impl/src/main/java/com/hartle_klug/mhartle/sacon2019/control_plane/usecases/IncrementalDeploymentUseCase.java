...
public class IncrementalDeploymentUseCase extends AbstractUseCase {
	private static final Logger LOG = LoggerFactory.getLogger(IncrementalDeploymentUseCase.class);

	public static final String PARAMETER_COMPLETION = "completion";
	
	public static final String LISTENER_SERVICE = "listener-service";
	
	public static final String CLUSTER_SERVICE_OLD = "cluster-service-old";
	public static final String CLUSTER_SERVICE_NEW = "cluster-service-new";
	...
	public void apply(Map<String, List<String>> parameters, SnapshotCache<String> snapshotCache, long version) throws Exception {
		...
		final Iterable<RouteConfiguration> routes = createRoutes(completion, version);
	...
	private static List<ClusterLoadAssignment> createEndpoints(final long version) {
		final List<ClusterLoadAssignment> result =
				...
				.add(
						...
						.setClusterName(CLUSTER_SERVICE_OLD)
						.addEndpoints(
				...
				.add(
						ClusterLoadAssignment.newBuilder()
						.setClusterName(CLUSTER_SERVICE_NEW)
						.addEndpoints(
								LocalityLbEndpoints.newBuilder()
								.addLbEndpoints(
										LbEndpoint.newBuilder()
	...
	private static List<RouteConfiguration> createRoutes(final float completion, final long version) {
									...
									.setRoute(
											...
											.setWeightedClusters(
													...
													.addClusters(
															...
															.setWeight(UInt32Value.of(Math.round((1.0f - completion) * 100.0f)))
															.setName(CLUSTER_SERVICE_OLD)
															.build())
													.addClusters(
															ClusterWeight.newBuilder()
															.setWeight(UInt32Value.of(Math.round(completion * 100.0f)))
															.setName(CLUSTER_SERVICE_NEW)
															.build())
													.build())
											.build())
